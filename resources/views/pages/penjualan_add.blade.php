<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex gap-8 flex-wrap">
            ...
            <div class="w-full relative overflow-x-auto shadow-sm sm:rounded-lg bg-white p-8">
                <h1 class="mb-8 text-xl text-center">Form Tambah Penjualan</h1>
                <form action="/penjualan/add" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-6">
                        <label for="pembeli" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Pembeli</label>
                        <input type="text" id="pembeli" name="pembeli" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-amber-600 focus:border-amber-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-600 dark:focus:border-amber-600" required>
                    </div>
                    <div class="mb-6">
                        <label for="status" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Status</label>
                        <select id="status-pembeli" name="status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-amber-600 focus:border-amber-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-600 dark:focus:border-amber-600" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="alamat" name="alamat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-amber-600 focus:border-amber-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-600 dark:focus:border-amber-600" required>
                    </div>
                    <div class="mb-6">
    ...
    <script>  
        ...
        const selectGas = () => {
            ...
            console.log(selectedGas.value.split('').find(gas => gas === '3'));
