            ...
            <div class="w-full relative overflow-x-auto shadow-sm sm:rounded-lg bg-white p-8">
                ...
                <form action="/jenis_gas/add" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" min="0" id="harga" name="harga" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-blue-500" required>
                    </div>
                    <div class="mb-6">
                        <label for="stok" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stok</label>
                        <input type="number" min="0" id="stok" name="stok" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-blue-500" required>
                    </div>
                    <div class="flex justify-end">
                        <button href="{{ route('jenis_gas') }}" class='h-9 rounded-md px-5 bg-slate-700 text-white flex justif-center items-center  active:bg-slate-600 cursor-pointer'>                              
                            <span>Simpan</span>
                        </button>
                    </div>
                  </form>
