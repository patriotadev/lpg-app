<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex gap-8 flex-wrap sm:rounded-lg">
            ...
            <h1 class="font-semibold text-slate-800">Laporan Penerimaan Tabung Gas</h1>
    ...
    <script>
        ...
        const data = {
            labels: gasList.map(element => element.jenis_gas),
            datasets: [{
                label: 'Jumlah',
                data: gasList.map(element => element.stok),
                backgroundColor: [
                'rgb(99,102,241)',
                '#f43f5e',
                '#8b5cf6',
