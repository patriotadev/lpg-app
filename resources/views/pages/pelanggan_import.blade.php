    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex gap-8 flex-wrap">
            ...
            <div class="w-full relative overflow-x-auto shadow-sm sm:rounded-lg bg-white p-8">
                <h1 class="mb-8 text-xl text-center">Upload Data Pelanggan</h1>
                <form action="/pelanggan/import" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-6">
                        <label for="pelanggan_excel_file" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload file</label>
                        <input type="file" id="pelanggan_excel_file" name="pelanggan_excel_file" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-blue-500">
                    </div>
